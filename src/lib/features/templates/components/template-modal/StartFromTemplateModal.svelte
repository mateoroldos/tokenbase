...
<Dialog.Root bind:open>
	...
	<Dialog.Content class="h-[90vh] min-w-[90vw] overflow-hidden p-0">
		<div class="grid grid-cols-[1fr_3fr] gap-16 overflow-hidden">
			<aside
				class="align-start flex flex-col gap-7 border-r border-slate-200 bg-slate-100 px-8 py-12"
			>
			...
			<div
				class="grid auto-rows-max grid-cols-2 gap-8 overflow-y-auto py-12 pl-0 pr-14"
			>
