...
<div
	class="flex flex-1 flex-col justify-between border-r border-solid bg-gray-100 px-5 py-4 overflow-hidden gap-6"
>
	<a href="/" class="text-lg font-medium">
		<SquareEqual class="mb-1 inline-block h-6 w-6" />
		Tokenbase
	</a>
	<div class="flex flex-1 overflow-auto flex-col gap-3">
